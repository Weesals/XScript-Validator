...
namespace RTS4.Common {
    public struct XReal : IConvertible, IEquatable<XReal>, IEqualityComparer<XReal> {
        ...
        public static readonly XReal One = new XReal(1);

        public bool Equals(XReal other) { return other.value == value; }
        public bool Equals(XReal r1, XReal r2) { return r1.value == r2.value; }
        public int GetHashCode(XReal obj) { return obj.value.GetHashCode(); }
